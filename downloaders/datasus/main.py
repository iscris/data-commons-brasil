                ...
                for dataset in datasets:
                    ...
                    for resource in resources:
                        ...
                        if file_type in [
                            ...
                            if search_button is not None:
                                ...
                                if file_type == "zip csv":
                                    file_name = (
                                        clean_filename(resource_item.text) + ".zip"
                                    )
                                ...
                                if file_type == "api":
                                    ...
                                    file_name = (
                                        clean_filename(resource_item.text) + ".json"
                                    )
                                    file_path = os.path.join(dataset_path, file_name)
                                    ...
                                    file_name = (
                                        clean_filename(resource_item.text)
                                        + "."
                                        + file_type
                                    )
                                    file_path = os.path.join(dataset_path, file_name)
                        ...
                        if file_type == "csv":
                            ...
                            if item is not None:
                                file_name = (
                                    clean_filename(resource_item.text) + "." + file_type
                                )
                                file_path = os.path.join(dataset_path, file_name)
