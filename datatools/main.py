...
from datatools.downloaders.ipea import ipea
from datatools.processor.main import run_processor
from datatools.importer.main import run_importer


def handle_downloader_option(option: str):
    if option == "ipea":
        ipea.download_ipea_data("output/downloader")
    else:
...
def main():
    ...
    processor_parser.add_argument("--values", type=str, help="")
